<title>View Teacher Information | Beam</title>
</head>
    ...
    <div class="page-content">
      <div class="mdl-grid">
          ...
          <section class="mdl-cell mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop mdl-card mdl-shadow--4dp mdl-cell--3-offset-desktop ">
            ...
            <?php echo form_open('admin/edit/teacher', 'class="mdl-grid"');
              ...
              <div class="mdl-cell mdl-cell--4-col-desktop mdl-cell-4-col-phone mdl-cell--3-col-tablet mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input disabled readonly value="<?php if(!is_null($teacher->last_verified)) { $d = strtotime($teacher->last_verified); echo date('M d, Y h:i:s A',$d); }else { echo 'N/A'; }?>" class="mdl-textfield__input" type="text" id="timestamp">
              ...
              <div class="mdl-cell mdl-cell--2-col-desktop mdl-cell-4-col-phone mdl-cell--3-col-tablet mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input disabled style="text-align: center" readonly value="<?php echo $teacher->department ?>" class="mdl-textfield__input" type="text" id="active">
              ...
              <a href="<?php echo base_url('admin/view_all/teachers') ?>" class="mdl-cell mdl-cell--5-col-desktop mdl-cell--4-col-phone mdl-cell--4-col-tablet mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color-text--white mdl-color--red">
                Cancel
              </a>
              <div class="mdl-cell mdl-cell--12-col"></div>
          ...
          <section class="mdl-cell mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop mdl-card mdl-shadow--4dp mdl-cell--3-offset-desktop ">
            ...
            <div class="mdl-grid" style="width: 100%">
              ...
              <a href="<?php echo base_url('admin/edit/teacher/disable/'.$teacher->id."?token=".md5($teacher->id + $_SESSION['id'])) ?>" class="mdl-cell mdl-cell--1-offset-desktop mdl-cell--5-col-desktop mdl-cell--4-col-phone mdl-cell--4-col-tablet mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color-text--white mdl-color--red">
                Disable Account
              </a>
              <?php } else { ?>  
              <a href="<?php echo base_url('admin/edit/teacher/enable/'.$teacher->id."?token=".md5($teacher->id + $_SESSION['id'])) ?>" class="mdl-cell mdl-cell--1-offset-desktop mdl-cell--5-col-desktop mdl-cell--4-col-phone mdl-cell--4-col-tablet mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color-text--white mdl-color--green">
                Enable Account
              </a>
              <?php } ?>       
              <a href="<?php echo base_url('admin/edit/teacher/reset/'.$teacher->id."?token=".md5($teacher->id + $_SESSION['id'])) ?>" class="mdl-cell mdl-cell--5-col-desktop mdl-cell--4-col-phone mdl-cell--4-col-tablet mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color-text--white mdl-color--blue-grey">
                Reset Password
              </a>                                 
              <div class="mdl-cell mdl-cell--12-col"></div>
            </div>
