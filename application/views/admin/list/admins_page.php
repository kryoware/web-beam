<title>Admin Management Panel | Beam</title>
</head>
  ...
  <div class="mdl-layout__header-row">
    ...
    <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect" for="user_menu">
      <a href="<?php echo base_url('admin/signup') ?>">
        <li class="mdl-menu__item"><i style="vertical-align: middle !important" class="material-icons">person_add</i> New Admin</li>
      </a>
...
<div class="mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--white">
  ...
  <nav class="mdl-navigation">
    <a class="mdl-navigation__link mdl-color-text--white mdl-color--pink" href="<?php echo base_url('admin/manage') ?>">
    ...
    <a class="mdl-navigation__link mdl-color-text--blue-grey-300" href="<?php echo base_url('admin/view/requests/pending') ?>">
      <i style="vertical-align: middle !important"  class="material-icons">feedback</i> Requests
    </a>
    <a class="mdl-navigation__link mdl-color-text--blue-grey-300" href="<?php echo base_url('admin/view/accounts/pending') ?>">
      <i style="vertical-align: middle !important"  class="material-icons">vpn_lock</i> Verification
    </a>
    <a class="mdl-navigation__link mdl-color-text--blue-grey-300" href="<?php echo base_url('admin/view/logs') ?>">
      <i style="vertical-align: middle !important" class="material-icons">assignment</i> System Logs
    </a>
  </nav>
</div>
    ...
    <div class="page-content">
      <div class="mdl-grid">
        ...
        <section class="mdl-cell mdl-cell--12-col mdl-card mdl-shadow--4dp">
          ...
          <div class="mdl-card__title mdl-color--pink mdl-color-text--white">
            <h2 class="mdl-card__title-text">All Admins</h2>
            <div class="mdl-layout-spacer"></div>
            ...
            <tbody>
              ...
              <tr>
                <td class="table-action mdl-data-table__cell--non-numeric">
                  <?php echo $admin->last_name.", ".$admin->first_name." ".$admin->middle_name[0]."." ?>
                </td>
                <td class="table-action mdl-data-table__cell--non-numeric">
                  <?php echo $admin->username ?>
                </td>
                <td class="table-action mdl-data-table__cell--non-numeric">
                  <?php echo substr($admin->phone_number, 0, 6).'****'.substr($admin->phone_number, 10, 3) ?>
                </td>
                ...
                <td class="table-action mdl-data-table__cell--non-numeric">
                  <?php echo $admin->active ? 'Active' : 'Disabled' ?>
                </td>

                <td class="table-action mdl-data-table__cell--non-numeric">
                  <a href="<?php echo base_url('admin/view/'.$admin->id.'?v='.md5($admin->id+$_SESSION['id'])) ?>" class="mdl-button mdl-js-button mdl-button--colored mdl-js-ripple-effect mdl-color-text--indigo">View</a>
                </td>
                <td class="table-action mdl-data-table__cell--non-numeric">
                  <a href="<?php echo base_url('admin/delete/'.$admin->id.'?d='.md5($admin->id+$_SESSION['id'])) ?>" onclick="return confirm('Delete this admin account?\n\nTHIS ACTION CANNOT BE UNDONE')" class="mdl-button mdl-js-button mdl-button--colored mdl-js-ripple-effect mdl-color-text--red">Delete</a>
                </td>
