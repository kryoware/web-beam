<title>Event Management Panel | Beam</title>
</head>
...
<header class="mdl-layout__header mdl-color--white">
  <div class="mdl-layout__header-row">
    ...
    <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect" for="user_menu">
      <a href="<?php echo base_url('admin/create/event') ?>">
        <li class="mdl-menu__item"><i style="vertical-align: middle !important" class="material-icons">event</i> New Event</li>
      </a>
          ...
          <table class="mdl-data-table mdl-js-data-table mdl-cell mdl-cell--12-col">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="table-action mdl-data-table__cell--non-numeric">
                  <a href="<?php echo base_url('admin/view/event/'.$event->id.'?v='.md5($event->id+$_SESSION['id'])) ?>" class="mdl-button mdl-js-button mdl-button--colored mdl-js-ripple-effect mdl-color-text--indigo">View</a>
                </td>
                <td class="table-action mdl-data-table__cell--non-numeric">
                  <a href="<?php echo base_url('admin/delete/event/'.$event->id.'?d='.md5($event->id+$_SESSION['id'])) ?>" onclick="return confirm('Delete this event? The poll linked to this event will also be deleted\n\nTHIS ACTION CANNOT BE UNDONE')" class="mdl-button mdl-js-button mdl-button--colored mdl-js-ripple-effect mdl-color-text--red">Delete</a>
                </td>
