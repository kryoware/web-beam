<title>Pending Accounts | Beam</title>
</head>
...
<div class="mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--white">
  ...
  <nav class="mdl-navigation">
    ...
    <a class="mdl-navigation__link mdl-color--grey-700 mdl-color-text--white" href="<?php echo base_url('admin/view/accounts/pending') ?>">
    ...
    <div class="page-content">
      <div class="mdl-grid">
        ...
        <section class="mdl-cell mdl-cell--12-col mdl-card mdl-shadow--4dp">
          ...
          <div class="mdl-card__title mdl-color--grey-700 mdl-color-text--white">
          ...
          <table class="mdl-data-table mdl-js-data-table mdl-cell mdl-cell--12-col">
            ...
            <tbody>
              <?php foreach($logs as $log) { $userType = $this->account_model->getUsertype($log->phone_number); ?>
              <tr>
                <td class="table-action mdl-data-table__cell--non-numeric">
                  <?php echo substr($log->phone_number, 0, 6).'****'.substr($log->phone_number, 10, 3) ?>
                </td>
                <td class="table-action mdl-data-table__cell--non-numeric">
                  <?php echo $log->verification_code ?>
                </td>
                <td class="table-action mdl-data-table__cell--non-numeric">
                  <?php echo $userType ?>
                </td>
                <td class="table-action mdl-data-table__cell--non-numeric">
                  <?php echo $log->sent == 1 ? 'Verification Code Sent' : 'Pending' ?>
                </td>
              </tr>
              <?php } ?>
            </tbody>
